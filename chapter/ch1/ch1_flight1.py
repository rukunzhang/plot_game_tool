...
def main():
    ...
    pl1 = Player(pl_image=cfg2.image_pl2, pl_name="少年", pl_pos=(100, 500))
    pl2 = Player(pl_image=cfg2.image_pl5, pl_name="守卫", pl_pos=(500, 500), show_mode=1)
    ...
    def pl2_attack():
        ...
        if pl2_time > 0:
            ...
            if pl2.get_mode() == "attack":
                bu2_group.add(pl2.push_attack(13, 1))
            pl2_mode = random.randint(0, 2)
            pl2.mode_change(pl2_mode)
            pl2_time = random.randint(50, 90)
