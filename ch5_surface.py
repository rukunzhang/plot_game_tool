from cfg import *
from cfg2 import *
import ch5_flight1_surface
import ch5_flight2_surface
import ch5_choose1_surface
    ...
    def plot_num_change_func():
        ...
        if plot_num != root_com[plot_root][-1]:
            ...
            if plot_root == 1:
                ...
                key = ch5_choose1_surface.main()
                if key == 1:
                    cfg2.choose_ch5.append(10)
                key = 0
                if 10 in cfg2.choose_ch1:
                    key += 1
                if 10 in cfg2.choose_ch2:
                    key += 1
                if 10 in cfg2.choose_ch3:
                    key += 1
                if 10 in cfg2.choose_ch4:
                    key += 1
                if 10 in cfg2.choose_ch5:
                    key += 1
                if key == 5:
                    plot_root = 4
                    plot_num = root_com[plot_root][0]
...
# 剧情文本读取
text0 = cfg2.text_get("resource/font/text5.txt")
# print(text0)
text1 = [[]]
for item in text0:
    for text in item:
...
# print(text1)
# 剧情图像绘制
image0 = cfg2.image_get("resource/font/image5.txt")
image1 = [[]]
for item in image0:
    if len(item) > 0:
        image1.append(item)
