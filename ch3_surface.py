from cfg import *
from cfg2 import *
import ch3_choose1_surface
import ch3_choose2_surface
import ch3_choose3_surface
import ch3_flight1_surface
import ch3_flight2_surface
import ch3_flight3_surface
        ...
        if plot_num != root_com[plot_root][-1]:
            ...
            if plot_root == 2:
                ...
                if key == 1:
                    ...
                    plot_root = 4
                    plot_num = root_com[plot_root][0]
            elif plot_root in [4, 5, 8]:
                if ch3_flight1_surface.main():
                    plot_root = 6
                    plot_num = root_com[plot_root][0]
                else:
                    plot_root = 15
                ...
                key = ch3_choose2_surface.main()
                if key == 1:
                    plot_root = 12
                    plot_num = root_com[plot_root][0]
                else:
                    if ch3_flight2_surface.main():
                        plot_root = 12
                        plot_num = root_com[plot_root][0]
                    else:
                        plot_root = 15
                ...
                if ch3_choose3_surface.main() == 1:
                    cfg2.choose_ch3.append(10)
                    plot_root = 14
                    plot_num = root_com[plot_root][0]
            else:
...
# 剧情文本读取
text0 = cfg2.text_get("resource/font/text3.txt")
# print(text0)
text1 = [[]]
for item in text0:
    for text in item:
...
# print(text1)
# 剧情图像绘制
image0 = cfg2.image_get("resource/font/image3.txt")
image1 = [[]]
for item in image0:
    if len(item) > 0:
        image1.append(item)
...
print(root_com)
print(len(root_com))
control = [[1], [2], [3, 4, 5], [7], [6], [6], [9], [8], [6], [10, 11], [12], [12], [13], [14], [0], [0], [0], [0]]
