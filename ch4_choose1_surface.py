...
def main():
    ...
    choose1_button = Button(screen, (200, 400),
                            text_in="·用门卡·", text_font=cfg2.font_path3, text_size=choose_font_size,
                            text_color=cfg2.color_white,
                            fill_color=True, edge_color=True, size=(104, 34),
                            call_function=func_choose1)

    choose2_button = Button(screen, (500, 400),
                            text_in="·用暴力·", text_font=cfg2.font_path3, text_size=choose_font_size,
                            text_color=cfg2.color_white,
                            fill_color=True, edge_color=True, size=(104, 34),
    ...
    def show():
        ...
        show_time -= 1
        if show_time > 0:
            str1.set_color((show_time, show_time, show_time))
            str1.show((400,300), screen, mode=4)
