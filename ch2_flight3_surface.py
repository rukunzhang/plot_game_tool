...
def main():
    ...
    # 游戏要素准备
    num = 30
    if 1 in cfg2.choose_ch2:
        num += 10
    if 2 in cfg2.choose_ch2:
        num += 10
    pl1 = Player(pl_image=cfg2.image_pl2, pl_name="少年", pl_pos=(100, 500), attack=num)
    pl2 = Player(pl_image=cfg2.image_pl3, pl_name="肖恩", pl_pos=(500, 500), show_mode=1)
    ...
    def pl2_attack():
        ...
        if pl2_time > 0:
            ...
            if pl2.get_mode() == "attack":
                bu2_group.add(pl2.push_attack(20, 1))
            pl2_mode = random.randint(0, 2)
            pl2.mode_change(pl2_mode)
            pl2_time = random.randint(30, 70)
