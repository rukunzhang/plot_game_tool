...
def main():
    ...
    # 游戏要素准备
    if 1 in cfg2.choose_ch1:
        pl1 = Player(pl_image=cfg2.image_pl2, pl_name="少年", pl_pos=(100, 500), attack=40)
    else:
        pl1 = Player(pl_image=cfg2.image_pl2, pl_name="少年", pl_pos=(100, 500), attack=30)
    pl2 = Player(pl_image=cfg2.image_pl6, pl_name="法贾", pl_pos=(500, 500), show_mode=1)
