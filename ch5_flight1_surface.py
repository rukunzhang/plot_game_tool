...
def main():
    ...
    # 游戏要素准备
    pl1 = Player(pl_image=cfg2.image_pl2, pl_name="少年", pl_pos=(100, 500), attack=20)
    pl2 = Player(pl_image=cfg2.image_pl4, pl_name="师兄", pl_pos=(500, 500), show_mode=1)
    ...
    def pl2_attack():
        ...
        if pl2_time > 0:
            ...
            if pl2.get_mode() == "attack":
                bu2_group.add(pl2.push_attack(50, 1))
